...
class PatientDetailFirebase extends StatelessWidget {
  final PatientModel patient;
  // final Record patient;
  const PatientDetailFirebase({Key? key, required this.patient})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    printInfo(info: 'images rays ${patient.rays!}');
    printInfo(info: 'images rays ${patient.id}');
    printInfo(info: 'images rays ${patient.name}');
    printInfo(info: 'images rays ${patient.details}');
    return Scaffold(
      appBar: AppBar(
