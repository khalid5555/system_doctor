        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              App_Text(
                data:
                    'تاريخ الاضافة : ${'${patient.createdAt!.day} : ${patient.createdAt!.month} : ${patient.createdAt!.year}'} ',
                size: 12,
                maxLine: 2,
              ),
              App_Text(
              ...
              SizedBox(height: 5.h),
              (patient.images == null /* && patient.analysis == null */)
                  ? const SizedBox()
                  : Row(
                                  ...
                                  itemBuilder: (context, index) {
                                    return InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl:
                                              "https://fagaskwt.com/public/${patient.images![index].img}",
                                          fit: BoxFit.fill,
                                          fadeInCurve: Curves.bounceOut,
                                          placeholder: (context, url) =>
                                              const ShowLoading(),
